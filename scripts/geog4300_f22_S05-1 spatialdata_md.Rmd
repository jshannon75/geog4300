...
First, we will be downloading public use microdata area (PUMA) boundaries for Atlanta. PUMAs have uniform populations, making them smaller than counties in metro areas but larger in rural ones. We will download boundaries using the tidycensus package and then filter for those whose name refers to Atlanta.
...
atl_pumas_points<-st_centroid(atl_pumas)
ggplot(atl_pumas_points) + geom_sf()
