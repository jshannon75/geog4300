...
Let's start with our random distribution of ACT scores. The following code simulates random population of 100 taking the ACT in 2011. The rnorm comes from the same suite of functions as pnorm and dnorm--it just generates a random distrubution from a population with the listed characteristics.
