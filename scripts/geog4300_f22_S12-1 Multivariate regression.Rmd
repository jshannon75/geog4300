...
model_all1<-lm(AvgDLSpF~Latitude+elev100+dist50,data=dlsf1)
summary(model_all1)
```
...
```{r}
stargazer(model_lat,model_elev,model_dist,model_all,model_all2,title="Comparison",type="text")
...
stargazer(model_lat,model_elev,model_dist,model_all,model_all2,title="Comparison",
