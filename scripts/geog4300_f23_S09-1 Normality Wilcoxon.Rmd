...
##You try it!
Go back to our census data (ACSCtyData_2019_ACS). What's the most normal variable you can find?

```{r}
acsdata<-read_csv("data/ACSCtyData_2019ACS.csv")
...
###Wilcoxon tests
The wilcox.test command does both non-parametric Wilcoxon tests. Here's the rank sum example using lecture data. Think about what the null hypothesis is here. What does a significant p-value tell you?
```{r}
