...
We sum the `HWEIGHT` variable because each respondant is weighted to get a representative profile of households. HWEIGHT is the number of households that respondent represents.
