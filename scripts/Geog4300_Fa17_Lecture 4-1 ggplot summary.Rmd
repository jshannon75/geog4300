...
Different "geoms" specify you want to plot those data. See this list of available geoms: http://sape.inf.usi.ch/quick-reference/ggplot2/geom. While ggplot is part of the tidyverse, it use the plus sign, not the pipe, to separate elements.
