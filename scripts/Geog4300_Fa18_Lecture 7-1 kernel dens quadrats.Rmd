...
We will continue working with our tornado data for this anlaysis as well.
...
We can also use the density function to create a kernel density map.
...
```{r}
kernel_map<-density(tornado_ppp,.25)
quad_map<-quadratcount(tornado_ppp,10,5)

plot(kernel_map)
plot(qmap, add=TRUE,col="white")
