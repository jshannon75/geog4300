...
##Procedure for spatial statistics##
...
**Question 1 task (4 points):** _Create a map using the tmap package that shows the location of all the crimes in the spokane_crimes data frame and the precinct boundaries. Using tmap's view mode, add the Carto Positron basemap as well._

**Question 2 task (4 points):** _For the crimes dataset, create code to calculate the mean center for (1) all crimes, (2) all robberies (see the “Offense” column). What are the coordinates of each? Interpret how any difference between them (e.g., direction and distance) is meaningful._
