...
**Question 4 (3 points)** _Create a command that estimates the margin of error for each state based on the national rate you calculated in question 1 and the total responses for each state. Then write a short explanation of your code, the purpose of each function you used._
