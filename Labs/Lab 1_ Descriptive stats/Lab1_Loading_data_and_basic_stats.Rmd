...
library(tidyverse)
Daymet_Cty_Summary_2005_2015 <- read_csv("Daymet_Cty_Summary_2005_2015.csv")
```
...
Download the csv file from the course ELC site. Load the file into R and closely examine each variable. 
